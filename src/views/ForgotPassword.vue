<template>
    <div class="flex items-center min-h-screen bg-grey bg-opacity-20">
        ...
        <div class="w-full lg:w-2/3 px-4 md:px-8 lg:px-12 max-w-4xl p-10 mx-auto bg-white rounded-md shadow-md hover:shadow-2xl">
            ...
            <h1 class="text-4xl text-blue font-bold py-4 border-b uppercase">Agrabah Logistics - Forgot Password</h1>

            <Form @submit="forgotPassword" :validation-schema="schema" v-slot="{ errors }" autocomplete="off">
                <div class="mt-10">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-semibold">Verification Code</label>
                        <Field 
                            ...
                            autocomplete="false"
                            class="appearance-none rounded relative block w-full px-3 py-2 placeholder-grey text-gray-600 focus:outline-none focus:ring-grey-dark focus:ring-0 focus:border-grey-dark focus:z-10 sm:text-sm"
                            :class="errors['verification_code'] ? 'border border-purple' : 'border border-grey'"
                        />
                        <ErrorMessage class="text-purple font-semibold text-sm block my-1" name="verification_code" />
                    </div>
