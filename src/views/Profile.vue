<template>
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 bg-gray-50">
            <Navbar @show-sidebar="$refs.sidebar.show()">Account Settings</Navbar>
...
<script>
    ...
    export default {
        ...
        components: { 
            SidebarMobile, SidebarDesktop, Navbar, H2, TabGroup, TabList, Tab, TabPanels, TabPanel, ButtonSolidBlue
        }
    }
</script>