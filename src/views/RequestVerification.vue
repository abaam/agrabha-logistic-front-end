<template>
    <div class="flex items-center min-h-screen bg-grey bg-opacity-20">
        ...
        <div class="w-full lg:w-2/3 px-4 md:px-8 lg:px-12 max-w-4xl p-10 mx-auto bg-white rounded-md shadow-md hover:shadow-2xl">
            ...
            <h1 class="text-4xl text-blue font-bold py-4 border-b uppercase">Forgot Password - Request Verification</h1>

            <Form @submit="requestVerification" :validation-schema="schema" v-slot="{ errors }">
                <div class="mt-10">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-semibold">Please input your registered phone number.</label>
                        <Field 
                    ...
                    <ButtonSolidBlue id="submit_btn" class="mb-4 flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    </svg>Send Verification Code</ButtonSolidBlue>
                </div>
            </Form>
            <div class="text-sm">
                Not registered yet? 
