            ...
            <div class="text-center">
                ...
                <form action="">
                    <div class="mb-4 w-full">
                        ...
                        <input type="number" class="appearance-none rounded relative block w-full px-3 py-2 border border-grey placeholder-grey text-gray-800 focus:outline-none focus:ring-grey-dark focus:ring-0 focus:border-grey-dark focus:z-10 sm:text-sm" />
                    </div>
...
<script>
    ...
    export default {
        components: { Navigation, ButtonSolidBlue }
    }
</script>